...
namespace SHARED_PS2_BIN.REPACK
{
    ...
    {
        public static FinalStructure MakeFinalStructure(IntermediaryStructure intermediaryStructure, float ConversionFactorValue)
        {
                    ...
                    if (vertexCount <= 44)
                    {
                        ...
                        if (intermediaryFace != null)
                        {
                            ...
                            for (int v = 0; v < intermediaryFace.Vertexs.Count; v++)
                            {
                                ...
                                finalVertex.PosX = Utils.ParseFloatToShort(intermediaryVertex.PosX / ConversionFactorValue);
                                finalVertex.PosY = Utils.ParseFloatToShort(intermediaryVertex.PosY / ConversionFactorValue);
                                finalVertex.PosZ = Utils.ParseFloatToShort(intermediaryVertex.PosZ / ConversionFactorValue);
